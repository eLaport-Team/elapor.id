<?php
    ...
    if($mod == "home"){
        ...
        echo "<div style='box-shadow: 0px 20px 5px 0px rgba(0,0,0,0.5); -webkit-box-shadow: 0px 10px 5px 0px rgba(0,0,0,0.5); -moz-box-shadow: 0px 20px 5px 0px rgba(0,0,0,0.5); text-align: center; width: 30% !important; background-color: #F9F9F9; padding: 20px; border: 1px solid #DDD; margin-top: -5%; margin-left: 35%; border-radius: 5px; font-size: 14pt;'>
